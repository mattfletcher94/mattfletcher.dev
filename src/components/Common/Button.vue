<template>
  <button
    :class="{
      ...
      'w-10 h-10': props.circle,

      'disabled:opacity-70 disabled:cursor-not-allowed': props.disabled,
    }"
    type="button"
...
const props = defineProps({
  variant: {
    type: String as PropType<'primary' | 'primary-outline' | 'secondary' | 'secondary-outline'>,
    default: 'primary',
  },
  circle: {
    type: Boolean,
